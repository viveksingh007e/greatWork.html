...
function startRun() {
    runExercise([
        ['जीवन जीने के लिए है, और हम जीने का मज़ा लेने आए हैं। हम आज पच्चीस मिनट तक दौड़ेंगे, यह एक बड़ी उपलब्धि होगी। हम ३० सेकंड में शुरू करेंगे।', 45],
        
        ['शुभकामनाएँ! आइए, आरंभ करते हैं!', 60],
        
        ['टाइमर चल रहा है, निश्चिंत रहें। चौबीस मिनट और हैं।', 480],

        ['अब सोलह मिनट और हैं।', 420],
